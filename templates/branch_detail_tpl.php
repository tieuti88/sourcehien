              ...
              <div class="col-md-12">
                  <div class="row content_1">
                    ...
                    <ul style="margin-left: -35px">
                      ...
                      <li style="list-style: none"><i class="fa fa-star-o"></i><a href="http://<?=$config_url?>/bai-viet-cong-ty/<?=$tintuc_khac[$i]['tenkhongdau']?>-<?=$tintuc_khac[$i]['id']?>.html" class="transitionAll">
