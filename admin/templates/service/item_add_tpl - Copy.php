...
<script language="javascript">			
	...
	{		
		...
		window.location ="index.php?com=service&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_cat="+b.value;	
		return true;
	}
	...
	{		
		...
		window.location ="index.php?com=service&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&id_cat="+b.value+"&id_item="+c.value;	
		return true;
	}
...
function get_main_category()
	...
	{
		$sql_huyen="select * from table_service_item where id_cat=".$_REQUEST['id_cat']." order by stt asc,id desc ";
