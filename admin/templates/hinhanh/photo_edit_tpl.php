...
<form name="frm" method="post" action="index.php?com=hinhanh&act=save_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">
	...
	<b>Class</b> <input type="text" name="mota" value="<?=@$item['mota']?>" class="input" /><br /><br>	
