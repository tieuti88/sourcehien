...
<form name="frm" method="post" action="index.php?com=product&act=save_type" enctype="multipart/form-data" class="nhaplieu">	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product&act=man_type'" class="btn" />
</form>