...
<form name="frm" method="post" action="index.php?com=chuongtrinh&act=save" enctype="multipart/form-data" class="nhaplieu">
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=chuongtrinh&act=capnhat'" class="btn" />
</form>