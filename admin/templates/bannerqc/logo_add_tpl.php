...
<form name="frm" method="post" action="index.php?com=bannerqc&act=save" enctype="multipart/form-data" class="nhaplieu">
	...
	<?php
	 ...
	 {
	 ?>
             <object width="80" height="80"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
             ...
             <embed src="<?=_upload_hinhanh.$item['photo']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="80" height="80" scale="ExactFit"></embed>
            </object>
	 ...
	 ?><br /><br />
	<b>Banner hiện tại: </b> 
    <input type="file" name="file" /> <strong>Width:80px&nbsp;-&nbsp;Height:80px&nbsp;Type:&nbsp;.jpg | png | gif</strong><br />
